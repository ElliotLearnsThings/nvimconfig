const snippets = [
  ...
  { trigger: "ns\<", replacement: "\\unlhd", options: "mA" },
  ...
  { trigger: "bre", replacement: "\\quad", options: "mA" },
  ...
  { trigger: "Ree", replacement: "\\mathrm{Re}($0) $1", options: "mA" },
  { trigger: "Im", replacement: "\\mathrm{Im}($0) $1", options: "mA" },
  { trigger: "imm", replacement: "\\mathrm{im}($0) $1", options: "mA" },
  { trigger: "Log", replacement: "\\mathrm{Log}($0) $1", options: "mA" },
  {
    trigger: "eLog",
    replacement: "\\mathsf{L}\\mathrm{og}($0) $1",
    options: "mA",
  },

  { trigger: "ord", replacement: "\\mathrm{ord}($0) $1", options: "mA" },
  ...
  { trigger: "sub-", replacement: "\\setminus $0", options: "mA" },
